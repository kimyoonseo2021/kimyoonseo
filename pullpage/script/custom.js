$(document).ready(function(){
	$('.ptTxtWrap').animate({'top':'0','left':'0','opacity':1},1000,'linear',
  $('.icon1').animate({'top':'10%','opacity':'1'},1500,'linear',
  $('.icon2').animate({'top':'12%','opacity':'1'},2000,'linear',
  $('.main').animate({'left':'45%','opacity':'1'},1000,'linear',
  $('.imgIcon1').animate({'top':'3%','opacity':'1'},2000,'linear',
  $('.imgIcon2').animate({'bottom':'5%','opacity':'1'},2000,'linear',
...
function fullset(){
	let pageindex = $("#fullpage > .fullsection").size(); //fullpage 안에 섹션이(.fullsection) 몇개인지 확인하기
